  ...
  data: () => ({
	...
	methods: {
      ...
      let bodyData = {
        ...
        tanggalLahirSuami: this.DataStepOne.tanggal_lahir_suami ? this.convertDateToPicker2(this.DataStepOne.tanggal_lahir_suami) : '0000-00-00',
        ...
        tanggalLahirIstri: this.DataStepTwo.tanggal_lahir_istri ? this.convertDateToPicker2(this.DataStepTwo.tanggal_lahir_istri) : '0000-00-00',
