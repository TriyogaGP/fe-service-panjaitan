  ...
  data: () => ({
	...
	methods: {
      ...
      let bodyData = {
        ...
        tanggalLahirSuami: this.DataStepOne.tanggal_lahir_suami ? this.convertDateToPicker2(this.DataStepOne.tanggal_lahir_suami) : null,
        ...
        tanggalLahirIstri: this.DataStepTwo.tanggal_lahir_istri ? this.convertDateToPicker2(this.DataStepTwo.tanggal_lahir_istri) : null,
